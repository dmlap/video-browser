  ...
  return (
    <main>
      <section className={styles.hero}>
        ...
        <p>
          Follow Jeremy Clarkson as he attempts to run a farm in the countryside. With no previous farming experience,
          Jeremy contends with the worst farming weather in decades, disobedient animals, unresponsive crops, and an
          unexpected pandemic.
        </p>
      </section>
      <section>
