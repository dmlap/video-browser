...
export function ChannelCarousel({ channels }) {
  ...
  return (
    <ol className={styles.channels} onFocus={handleFocusFor(ref, channels)} ref={ref}>
      {channels.map((channel, ix) => {
        return (
          <li key={ix} className={styles.item}>
...
export default function Carousel({ videos }) {
  ...
  return (
    <ol className={styles.videos} onFocus={handleFocusFor(ref, videos)} ref={ref}>
      {videos.map((video, ix) => {
        return (
          <li key={ix} className={styles.item}>
